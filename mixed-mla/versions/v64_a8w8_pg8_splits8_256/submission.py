"""
v64: a8w8 pg8 with splits=8 for (256,8192) instead of splits=16.

Change from v43: A8W8_PG8_SPLITS (256,8192) = 8 (was 16).
Rationale: 256 batches x 16 heads x 8 splits = 32768 blocks on 304 CUs = 107 blocks/CU.
Plenty of occupancy. Fewer splits = less reduce overhead.
...
# v64 CHANGE: splits=8 for (256,8192) instead of 16
A8W8_PG8_SPLITS = {
    (4, 8192): 8,
    (32, 8192): 16,
    (64, 8192): 16,
