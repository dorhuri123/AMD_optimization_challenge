"""
v63: a16w8 pg1 with splits=4 for (64,1024) instead of splits=8.

Change from v43: A16W8_PG1_SPLITS (64,1024) = 4 (was 8).
Rationale: AITER auto-tuner suggested splits=4. Fewer splits = less reduce overhead.
...
# v63 CHANGE: splits=4 instead of 8
