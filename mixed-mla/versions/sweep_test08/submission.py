"""
sweep_test08: aggressive a16w8 splits: (64,8192)=32, (256,1024)=12.
...
def _get_a16w8_pg2_meta(batch_size, kv_seq_len, num_kv_splits, qo_indptr, kv_indptr, use_fast_mode=True):
    key = (batch_size, kv_seq_len, num_kv_splits, use_fast_mode)
...
def _a16w8_pg2_path(q, kv_data, qo_indptr, kv_indptr, config):
    ...
    A16W8_SPLIT_MAP = {(32,8192):16, (64,1024):8, (64,8192):32, (256,1024):12}
    num_kv_splits = A16W8_SPLIT_MAP.get((batch_size, kv_seq_len), 16)
    ...
    (wm, wi, wis, ri, rfm, rpm, kv_indices, kv_last_page_lens, kv_indptr_paged) = \
        _get_a16w8_pg2_meta(batch_size, kv_seq_len, num_kv_splits, qo_indptr, kv_indptr, use_fast_mode=use_fast)
