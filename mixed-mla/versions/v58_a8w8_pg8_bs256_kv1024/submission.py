"""
v58: For (256,1024) try a8w8 pg8 instead of a16w8 pg2.
The a8w8 pg8 path is the fastest for kv=8192 configs. For kv=1024 with bs=256,
the Q quantization overhead (~5us) may be offset by the faster ASM kernel with pg8.

Changes from v43:
  - (256,1024): a8w8 pg8 splits=16 (was a16w8 pg2 splits=16)
  - Removed Path C (a16w8 pg2) since no config uses it
"""
...
# Path D: a8w8 pg8 — all kv=8192 configs AND (256,1024)
A8W8_PG8_SPLITS = {
    (4, 8192): 8,
    (32, 8192): 16,
    (64, 8192): 16,
    (256, 8192): 16,
    (256, 1024): 16,  # NEW: try a8w8 pg8 for this config
}
...
# ===============================================================
# PATH D: a8w8 pg8 (for ALL kv=8192 AND (256,1024))
# ===============================================================
