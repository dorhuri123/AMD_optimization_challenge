"""
v61: MXFP4 Triton with BLOCK_N=32 instead of 64.
Less register pressure per tile, more iterations but potentially better occupancy.
For kv=1024 with splits=4, each split processes ~256 tokens = 8 tiles (BLOCK_N=32)
vs 4 tiles (BLOCK_N=64). The smaller tile may be better for small-kv workloads.

Changes from v43:
  - MXFP4 Triton BLOCK_N=32 (was 64) for (4,1024) and (32,1024)
"""
...
# Path A: MXFP4 Triton — with BLOCK_N=32
...
# ===============================================================
# MXFP4 TRITON KERNEL -- STAGE 1 (BLOCK_N=32)
# ===============================================================
...
# ===============================================================
# PATH A: MXFP4 TRITON with BLOCK_N=32 (for (4,1024) and (32,1024))
# ===============================================================
...
def _mxfp4_path(q, kv_data, kv_indptr, config):
    """Path A: MXFP4 dot_scaled with BLOCK_N=32 for small configs."""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Path A: MXFP4 Triton BLOCK_N=32 for (4,1024) and (32,1024)
