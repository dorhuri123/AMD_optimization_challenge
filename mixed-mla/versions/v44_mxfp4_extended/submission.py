"""
v44: Extend MXFP4 Triton to more kv=1024 configs.

Changes from v43:
  - Add (64,1024) and (256,1024) to MXFP4 Triton path
  - Remove a16w8 pg1 and pg2 paths (no longer needed)
  - Tune splits: (64,1024)=8, (256,1024)=16

Routing:
  (4,1024):   MXFP4 Triton splits=4   -> ~21us
  (32,1024):  MXFP4 Triton splits=4   -> ~30us
  (64,1024):  MXFP4 Triton splits=8   -> ~35us? (was 40.5us a16w8 pg1)
  (256,1024): MXFP4 Triton splits=16  -> ~50us? (was 55.7us a16w8 pg2)
  (4,8192):   a8w8 pg8 splits=8        -> 28.8us
  (32,8192):  a8w8 pg8 splits=16       -> 34.2us
  (64,8192):  a8w8 pg8 splits=16       -> 42.7us
  (256,8192): a8w8 pg8 splits=16       -> 81.4us
"""
...
# Path A: MXFP4 Triton -- ALL kv=1024 configs
MXFP4_CONFIGS = {(4, 1024), (32, 1024), (64, 1024), (256, 1024)}
MXFP4_KV_SPLITS = {
    (4, 1024): 4,
    (32, 1024): 4,
    (64, 1024): 8,
...
# ===============================================================
# PATH A: MXFP4 TRITON (for ALL kv=1024 configs)
# ===============================================================
...
def _mxfp4_path(q, kv_data, kv_indptr, config):
    """Path A: MXFP4 dot_scaled for all kv=1024 configs."""
