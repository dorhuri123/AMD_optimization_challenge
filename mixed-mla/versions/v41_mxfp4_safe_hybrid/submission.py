"""
v41: v24 but (64,1024) uses a16w8 pg1 (pg2 failed seed 1357 on leaderboard).
All other routing identical to v24.
"""
...
# Path B: a16w8 + PAGE_SIZE=2 (removed (64,1024) — fails seed 1357)
A16W8_PG2_CONFIGS = {(32, 8192), (64, 8192), (256, 1024)}
# splits: 8 if total_kv<=4096 else 16

# Path B2: a16w8 + PAGE_SIZE=1 for (64,1024) — safe from pg2 failures
...
# ===============================================================
# PATH B2: a16w8 + PAGE_SIZE=1 (for configs where pg2 fails)
# ===============================================================
...
def custom_kernel(data: input_t) -> output_t:
    ...
    elif (bs, kvlen) in A16W8_PG1_CONFIGS:
