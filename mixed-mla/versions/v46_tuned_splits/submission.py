"""
v46: Tune split counts for underperforming configs.

Changes from v43:
  - (64,1024) a16w8 pg1: splits=16 (was 8) -- more parallelism
  - (256,1024) a16w8 pg2: splits=8 (was 16) -- less reduce overhead
  - (256,8192) a8w8 pg8: splits=24 (was 16) -- more parallelism for large kv

Routing:
  (4,1024):   MXFP4 Triton splits=4   -> ~21us
  (32,1024):  MXFP4 Triton splits=4   -> ~30us
  (64,1024):  a16w8 pg1 splits=16      -> ~38us? (was 40.5us splits=8)
  (256,1024): a16w8 pg2 splits=8       -> ~52us? (was 55.7us splits=16)
  (4,8192):   a8w8 pg8 splits=8        -> ~29us
  (32,8192):  a8w8 pg8 splits=16       -> ~34us
  (64,8192):  a8w8 pg8 splits=16       -> ~43us
  (256,8192): a8w8 pg8 splits=24       -> ~78us? (was 81.4us splits=16)
"""
...
A16W8_PG1_SPLITS = {
    (64, 1024): 16,   # CHANGED: was 8
}

A16W8_PG2_CONFIGS = {(256, 1024)}
A16W8_PG2_SPLITS = {
    (256, 1024): 8,    # CHANGED: was 16
}
