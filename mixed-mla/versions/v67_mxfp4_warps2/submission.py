"""
v67: MXFP4 Triton with num_warps=2 instead of default (4).

Change from v43: Explicitly set num_warps=2 for MXFP4 stage1 kernel.
Rationale: Fewer warps = less contention for register file, potentially
better for small batch sizes (4, 32) where we have few programs and
register pressure is low. Each warp gets more registers.
...
# v67 CHANGE: num_warps=2 for stage1 kernel launch
# ===============================================================
...
def _mxfp4_path(q, kv_data, kv_indptr, config):
    ...
    # v67 CHANGE: num_warps=2 instead of default 4
