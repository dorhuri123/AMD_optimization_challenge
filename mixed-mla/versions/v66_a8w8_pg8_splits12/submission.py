"""
v66: a8w8 pg8 with splits=12 for (32,8192) and (64,8192).

Change from v43: A8W8_PG8_SPLITS for (32,8192) and (64,8192) = 12 (was 16).
Rationale: Middle ground between our splits=16 and AITER auto-tuner's splits=9.
Fewer splits = less reduce overhead while maintaining enough parallelism.
...
# v66 CHANGE: splits=12 for (32,8192) and (64,8192) instead of 16
A8W8_PG8_SPLITS = {
    (4, 8192): 8,
    (32, 8192): 12,
    (64, 8192): 12,
